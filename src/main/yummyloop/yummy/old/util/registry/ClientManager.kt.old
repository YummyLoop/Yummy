package yummyloop.yummy.old.util.registry
...
object ClientManager {
    private var modId : String = ModConfig.modId
    private val logger = ModConfig.logger
    private val isClient : Boolean = ModConfig.isClient()
